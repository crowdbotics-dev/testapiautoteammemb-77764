...
## Project Structure
    ...
    ├── testapiautoteammemb_77764  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_77764`
...
2. Clone this repo and `cd testapiautoteammemb_77764`
